...
const Section14: FC<Props> = (props): JSX.Element => {
  ...
  return (
    <section
      ...
      className="relative bg-gradient-to-b from-[#f7f2ed] to-[#faf6e4] pt-[100px] pb-[300px] after:content-[url('/home-page/section-14-bottom-background.webp')] after:left-0 after:bottom-[-7px] after:absolute after:z-[2]"
    >
      ...
      <ContentContainer customClassName="relative">
        ...
        <Image
          src={customer_logo_1}
          alt="Customer logo 1"
          className="absolute left-0 -translate-x-full -translate-y-1/2 top-0"
          width={170}
          height={170}
        />
        ...
        <Image
          src={customer_logo_2}
          alt="Customer logo 2"
          className="absolute left-0 -translate-x-1/3 top-20"
          width={160}
          height={160}
        />
        ...
        <Image
          src={customer_logo_3}
          alt="Customer logo 3"
          className="absolute left-0 -bottom-24 -translate-x-1/2 z-[3]"
          width={170}
          height={170}
        />
        ...
        <Image
          src={customer_logo_6}
          alt="Customer logo 6"
          className="absolute right-[5%] -bottom-44 z-[3]"
          width={170}
          height={170}
        />
        ...
        <Image
          src={customer_logo_7}
          alt="Customer logo 7"
          className="absolute -right-[5%] -bottom-16 z-[3]"
          width={170}
          height={170}
        />
        ...
        <Image
          src={customer_logo_8}
          alt="Customer logo 8"
          className="absolute -right-[15%] -bottom-44 z-[3]"
          width={170}
          height={170}
        />
        ...
        <Image
          src={customer_logo_9}
          alt="Customer logo 9"
          className="absolute -right-[10%] top-0 z-[3]"
          width={170}
          height={170}
        />
      </ContentContainer>
