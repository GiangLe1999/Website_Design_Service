...
import PostNavigation from '@/components/blog-page/post-navigation';
...
export default function PostLayout({ content, children, next, prev }: Props) {
  ...
  return (
    <article>
      <header className="mt-[100px] space-y-1 rounded-lg bg-primary py-4 px-2 text-center sm:py-6 md:py-10">
