  ...
  return (
    <section id={t('id')} className="relative bg-white pt-[100px]">
      <ContentContainer customClassName="max-w-[900px]">
        <CustomHeading2 t={t} type_4 customClassname="text-center mb-12" />
      </ContentContainer>

      <ContentContainer>
        <div className="relative grid grid-cols-2 gap-52">
          {/* Left */}
          <div>
          ...
          <Image
            src={steps_line}
            alt="Steps line"
            className="absolute left-1/2 -translate-x-1/2 top-8 xl:block hidden"
          />
        </div>
      </ContentContainer>
    </section>
